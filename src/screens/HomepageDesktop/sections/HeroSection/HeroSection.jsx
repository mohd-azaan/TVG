		...
		<section className='relative w-full h-[100vh]'>
			...
			<div className='relative max-w-[1920px] mx-auto h-full px-4 sm:px-6 lg:px-10'>
				...
				<div className='relative z-40 mt-[15vh] lg:ml-[15vw] md:ml-[10vw] max-w-[560px]'>
					<p className="[font-family:'Morganite',Helvetica] font-bold text-[32px] sm:text-[42px] lg:text-[57px] tracking-[1.10px] leading-[0.5] text-white">
					...
					<h1 className="mt-6 text-white font-[900] text-[clamp(110px,12vw,160px)] leading-[0.88] [font-family:'Morganite',Helvetica]">
						WHERE GOLF
						<br />
						JUST GOT AN
						<br />
					...
					<p className='mt-1 text-[#dedede] text-[24px] leading-7 lg:max-w-[535px] md:max-w-[500px] sm:max-w-[400px] font-TVG-typography-hero-text font-[number:var(--TVG-typography-hero-text-font-weight)]'>
