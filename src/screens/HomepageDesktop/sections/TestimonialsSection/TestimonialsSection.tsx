              ...
              <div className="relative z-10 space-y-6 sm:space-y-8">
                <div className="relative">
                  ...
                  <blockquote className="text-lg sm:text-xl lg:text-2xl xl:text-[26px] font-medium text-white leading-relaxed relative z-10 pl-8 sm:pl-12">
                    ...
                    justo vitae sagittis auctor, mi diam laoreet elit,
                    aliquet dignissim orci turpis vitae eros. Nulla
                    eget pretium diam, vel egestas dui. Ut arcu eros,
                    fermentum sit amet dolor a, elementum vehicula purus.
                  </blockquote>
                </div>
