...
// Saudi Riyal symbol component (use existing SVG asset)
	...
	return (
		<div className='relative w-full bg-white py-16'>
			...
			<div className='max-w-[1360px] mx-auto px-4 flex gap-[50px] items-center justify-center mb-16'>
				...
				<div className='bg-[#f6f6f6] rounded-[30px] w-[420px] h-auto relative'>
					...
					<div className='bg-[#009444] rounded-t-[30px] h-[87px] flex items-center justify-between px-8'>
						<h3 className='font-TVG-typography-tagline text-[28px] text-white uppercase tracking-[0.56px]'>
							Start
						</h3>
					...
					<div className='text-center py-6'>
						<div className='flex items-baseline justify-center gap-3'>
							<SaudiRiyalSymbol className='w-[36px] h-[36px] mb-1 text-black' />
							<span className='font-morganite text-[120px] leading-[110px] text-black uppercase tracking-[2.4px]'>
								199
							</span>
							<span className='font-TVG-typography-default text-[22px] text-black ml-2'>
								/person
							</span>
						</div>
					</div>
					...
					<div className='px-6 mb-8'>
						<div className='bg-[#f9f9f9] border border-neutral-200 rounded-[30px] p-6'>
							<h4 className='font-TVG-typography-tagline text-[27px] text-black uppercase mb-4'>
								Swing Evaluation
							</h4>
					...
					<div className='px-6 space-y-4 mb-8'>
						<div className='text-center border-t border-gray-200 pt-4'>
							<p className='font-TVG-typography-default text-[20px] text-black'>
								45-minute session
							</p>
						</div>
						<div className='text-center border-t border-gray-200 pt-4'>
				...
				<div className='bg-[#f6f6f6] rounded-[30px] w-[420px] h-auto relative'>
					...
					<div className='px-6 space-y-4 mb-8'>
						...
						<div className='border-t border-gray-200 pt-4'>
							<p className='font-inter font-bold text-[18px] text-black mb-4'>
								ADULTS
							</p>
							...
							<div className='space-y-2'>
								<div className='flex items-center justify-between'>
									<div className='bg-[#cceada] px-4 py-2 rounded-[50px]'>
										<span className='font-TVG-typography-button text-[18px] text-black'>
											60-Minute
										</span>
									</div>
									<div className='flex items-center gap-1'>
										<SaudiRiyalSymbol />
										<span className='font-TVG-typography-tagline text-[30px]'>
											500
										</span>
									</div>
								</div>
				...
				<div className='bg-[#f6f6f6] rounded-[30px] w-[420px] h-auto relative'>
					...
					<div className='px-6 mb-8'>
						<div className='bg-[#f9f9f9] border border-neutral-200 rounded-[30px] p-6'>
							...
							<p className='font-TVG-typography-default text-[20px] leading-[28px] text-[#757575]'>
								Become a member or book simulator time with your coach, apply
								what you've learned, and measure real improvement by challenging
								your coach in gameplay.
								<br />
								<br />
					...
					<div className='px-6 space-y-4 mb-8'>
						...
						<div className='text-center border-t border-gray-200 pt-4'>
							<div className='flex items-center justify-between'>
								...
								<div className='flex items-center gap-1'>
									<span className='font-TVG-typography-default text-[30px]'>
										+
									</span>
									<SaudiRiyalSymbol />
									<span className='font-TVG-typography-tagline text-[30px]'>
									...
									<span className='font-TVG-typography-default text-[20px]'>
										/hour
									</span>
								</div>
							</div>
			...
			<div className='text-center space-y-2'>
				...
				<p className='font-TVG-typography-default text-[20px] text-[#757575]'>
					<span className='font-TVG-typography-tagline text-black'>NOTE:</span>{' '}
					The prices are exclusive of 15% VAT
				</p>
			</div>
		</div>
	);
